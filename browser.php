		...
		*/
	    ...
	    protected function checkBrowserOpera() {
		    if( stripos($this->_agent,'opera mini') !== false ) {
			    ...
			    $this->setVersion(strrchr($this->_agent,"OPR/"));
			    $this->_browser_name = self::BROWSER_OPERA;
			    return true;
		    }
			return false;
	    ...
	    protected function checkPlatform() {
		    if( stripos($this->_agent, 'windows') !== false ) {
				...
				if( stripos($this->_agent, 'NT 5.1') !== false ) {
					$this->_platform = self::PLATFORM_WINDOWS_XP;
				}
				elseif( stripos($this->_agent, 'NT 6.0') !== false ) {
					$this->_platform = 'Windows Vista / Server 2008';
				}
				elseif( stripos($this->_agent, 'NT 6.1') !== false ) {
					$this->_platform = 'Windows 7 / Server 2008 R2';
				}
		    }
